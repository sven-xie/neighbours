...
import 'package:neighbours/ui/widgets/c_circle_avatar.dart';
import 'package:neighbours/ui/widgets/c_container.dart';
import 'package:neighbours/ui/widgets/c_image.dart';
import 'package:neighbours/ui/widgets/c_text.dart';
import 'package:neighbours/utils/string_util.dart';
              ...
              CContainer(
                ...
                children: <Widget>[
                  CContainer(
                    ...
                    children: <Widget>[
                      ImageWidget(name: "收藏",asset: "assets/images/ic_mine_star.png",),
                      ImageWidget(name: "评价",asset: "assets/images/ic_mine_appraise.png",),
                      ImageWidget(name: "最近浏览",asset: "assets/images/ic_mine_history.png",),
                    ],
                  ),
                  Divider(height:35,color: Colors.grey[300],),
                  Container(
                    alignment: Alignment.centerLeft,
                    child: CText("钱包",bold: true,textSize: 13,),
                  ),
                  GridView.count(
                    ...
                    children: <Widget>[
                      ImageWidget(name: "我的钱包",asset: "assets/images/ic_mine_wallet.png",),
                      ImageWidget(name: "红包/卡券",asset: "assets/images/ic_mine_red_bag.png",),
                      ImageWidget(name: "余额",asset: "assets/images/ic_mine_balance.png",),
                      ImageWidget(name: "理财",asset: "assets/images/ic_mine_financing.png",),
                      ImageWidget(name: "手机充值",asset: "assets/images/ic_mine_recharge.png",),
                    ],
                  ),
                  Divider(height: 25,color: Colors.grey[300],),
                  CImage(asset: "assets/images/banner_mine.png",),
                  Divider(height: 25,color: Colors.grey[300],),
                  Container(
                    alignment: Alignment.centerLeft,
                    child: CText("服务",bold: true,textSize: 13,),
                  ),
                  GridView.count(
                    ...
                    childAspectRatio: 1.2,
                    children: <Widget>[
                      ImageWidget(name: "新个税计算",asset: "assets/images/ic_mine_tax.png",),
                      ImageWidget(name: "火车票/机票",asset: "assets/images/ic_mine_train.png",),
                      ImageWidget(name: "会员中心",asset: "assets/images/ic_mine_vip.png",),
                      ImageWidget(name: "公益",asset: "assets/images/ic_mine_welfare.png",),
                      ImageWidget(name: "免流",tag:"领券",asset: "assets/images/ic_mine_flux.png",),
                      ImageWidget(name: "发票助手",asset: "assets/images/ic_mine_bill.png",),
                      ImageWidget(name: "我要合作",asset: "assets/images/ic_mine_cooperate.png",),
                      ImageWidget(name: "关于",asset: "assets/images/ic_mine_about.png",),
                    ],
                  ),
                ],
              )
