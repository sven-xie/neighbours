...
abstract class RefreshIndicatorState<T extends RefreshIndicator>
    extends State<T> {
  AllRoundRefresherState get refresher => AllRoundRefresher.of(context);
...
//      refresher.widget.controller.footerMode.value == LoadStatus.loading;
  ...
  void _handleOffsetChange() {
    //  print("_handleOffsetChange $mounted");
    if (!mounted) {
      return;
    }
  ...
  void handleModeChange() {
    ...
    if (mode == LoadStatus.loading) {
      // print("handleModeChange Loading");
  ...
  void handleDragMove() {
    ...
    // print("_scrollController.position.extentAfter <= widget.triggerDistance = ${_scrollController.position.extentAfter <= widget.triggerDistance}");
